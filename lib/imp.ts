...
// `src` is the extension's identifier on the connect flow — the SDK's
// `isForExtension` gates the connect-success content script on it.
export const IMP_SRC = 'bilingual-tube'
